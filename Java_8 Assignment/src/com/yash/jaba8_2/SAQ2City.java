...
public class SAQ2City {
	...
	public SAQ2City(int cityid, String cityname, StateStream objState, float pollutionIndex, int population,
			int area_of_city) {
		super();
		this.cityid = cityid;
		this.cityname = cityname;
	...
	public String toString() {
		return "SAQ2City [cityid=" + cityid + ", cityname=" + cityname + ", objState=" + objState + ", pollutionIndex="
